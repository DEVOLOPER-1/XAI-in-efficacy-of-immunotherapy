...
% Ensure fancyhdr has enough headroom to avoid \headheight warnings
\setlength{\headheight}{14.5pt}

% Safe include: only include graphic if file exists, otherwise draw a framed
% placeholder. Usage: \includeGraphicIfExists[<keyvals>]{<filename>}.
% Use \DeclareRobustCommand and \detokenize to avoid issues when writing aux/bookmarks
\DeclareRobustCommand{\includeGraphicIfExists}[2][]{%
  \IfFileExists{#2}{\includegraphics[#1]{#2}}{%
	\fbox{\parbox[c][5em][c]{0.9\linewidth}{\centering\textbf{Missing figure:} \detokenize{#2}}}%
  }%
}
...
\centering
	...
	\includeGraphicIfExists[width=\textwidth]{fig_placeholder_roc_tabular.pdf}
...
\centering
	...
	\includeGraphicIfExists[width=\textwidth]{fig_placeholder_roc_image.pdf}
...
\centering
	...
	\includeGraphicIfExists[width=\textwidth]{fig_placeholder_roc_fusion.pdf}
\caption{Fusion: Late, MMDL (+ GBT baseline)}
\label{fig:roc_fusion}
\end{subfigure}
\caption{Figure 1: Risk Stratification Performance (AUROC at TMB $\geq$ 10 Mut/Mb threshold).
...
\centering
	...
	\includeGraphicIfExists[width=\textwidth]{fig_placeholder_shap_summary.pdf}
...
\centering
	...
	\includeGraphicIfExists[width=\textwidth]{fig_placeholder_lime_local.pdf}
...
\begin{figure}[H]
\centering
	\includeGraphicIfExists[width=0.8\textwidth]{fig_placeholder_pdp_curves.pdf}
...
\centering
	...
	\includeGraphicIfExists[width=\textwidth]{fig_placeholder_gradcam_high_tmb.pdf}
...
\centering
	...
	\includeGraphicIfExists[width=\textwidth]{fig_placeholder_gradcam_low_tmb.pdf}
...
\begin{figure}[H]
\centering
	\includeGraphicIfExists[width=0.8\textwidth]{fig_placeholder_cell_deconv.pdf}
...
\hline
\textbf{Subgroup} & \textbf{n} & \textbf{RMSE} & \textbf{AUROC} & \textbf{\(\Delta\) RMSE*} & \textbf{p-value} & \textbf{Disparity} \\
\hline
Overall & 42 & 1.23 & 0.79 & -- & -- & Baseline \\
Male & 28 & 1.19 & 0.81 & -0.04 & 0.73 & Acceptable \\
Female & 14 & 1.31 & 0.76 & +0.08 & 0.73 & Acceptable \\
Age $\leq$50 & 18 & 1.15 & 0.82 & -0.08 & 0.62 & Acceptable \\
...
\hline
\multicolumn{7}{l}{* \(\Delta\) RMSE = subgroup RMSE - overall RMSE. Negative = better performance in subgroup.} \\
